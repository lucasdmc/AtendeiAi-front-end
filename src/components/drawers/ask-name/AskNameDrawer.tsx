// Drawer de configuração do nó "Perguntar por um nome"
...
export interface AskNameConfig {
...
export function AskNameDrawer({
  open,
  onClose,
  value,
  onChange,
}: AskNameDrawerProps) {
  const [localValue, setLocalValue] = useState<AskNameConfig>(value);
