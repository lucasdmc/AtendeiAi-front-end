...
export const BLOCK_DEFINITIONS: BlockDefinition[] = [
  ...
  },
  {
    ...
    category: 'ask',
    icon: 'Phone',
    title: 'Perguntar por um telefone',
    description: 'Captura e valida um número de telefone.',
    badge: 'PERGUNTAR',
    color: '#3B82F6',
    outputs: 3,
    hasInput: true,
  ...
  },
  {
    ...
    category: 'ask',
    icon: 'MapPin',
    title: 'Perguntar por um endereço',
    description: 'Captura e valida um endereço completo.',
    badge: 'PERGUNTAR',
    color: '#3B82F6',
    outputs: 3,
    hasInput: true,
